...
const Swapper: React.FC<Props> = ({smartAccount, provider, loading}) => {
  ...
  const handleSwap = async () => {
    ...
    toast.success(<a href={txLink} target='_blank'>Success! Click here for your transaction!</a>, {
      position: "top-right",
      autoClose: 15000,
      hideProgressBar: false,
      closeOnClick: true,
    ...
    <div className={styles.container}>
      ...
      <div className={styles.swapContainer}>
        {!loading && (
          ...
          <input className={styles.input} type="number" placeholder="0" onChange={(e) => setAmount(e.target.value)} />
          </div>
        ...
        <svg className={styles.imageItem} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5D6785" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><polyline points="19 12 12 19 5 12"></polyline></svg>
